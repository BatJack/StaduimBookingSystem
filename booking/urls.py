...
urlpatterns = [
    ...
    path('manage/court-types/', views.admin_court_type_list, name='admin_court_type_list'),
    path('manage/court-types/add/', views.admin_court_type_add, name='admin_court_type_add'),
    path('manage/court-types/edit/<int:type_id>/', views.admin_court_type_edit, name='admin_court_type_edit'),
    path('manage/court-types/delete/<int:type_id>/', views.admin_court_type_delete, name='admin_court_type_delete'),
